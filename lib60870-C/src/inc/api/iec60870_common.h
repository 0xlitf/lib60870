...
typedef enum {
    ...
    M_ME_ND_1 = 21, // normalized value without quality descriptor
    M_SP_TB_1 = 30, // single-point information with time tag
    M_DP_TB_1 = 31, // double-point information with time tag
    M_ST_TB_1 = 32, // step position information with time tag
    M_BO_TB_1 = 33, // bitstring of 32 bits with time tag
    M_ME_TD_1 = 34, // normalized value with time tag
    M_ME_TE_1 = 35, // scaled value with time tag
    M_ME_TF_1 = 36, // floating point with time tag
    M_IT_TB_1 = 37, // integrated totals with time tag
    M_EP_TD_1 = 38, // event of protection equipment with CP56Time2a time tag
    M_EP_TE_1 = 39, // packed start events of protection equipment with CP56Time2a time tag
    M_EP_TF_1 = 40, // packed output circuit information of protection equipment with CP56Time2a time tag
    S_IT_TC_1 = 41,
    C_SC_NA_1 = 45, // single command
    C_DC_NA_1 = 46, // double command
    C_RC_NA_1 = 47, // regulating step command
    C_SE_NA_1 = 48, // set-point normalised command
    C_SE_NB_1 = 49, // set-point scaled command
    C_SE_NC_1 = 50, // set-point short floating point command
    ...
    C_SE_TA_1 = 61, // set-point normalised command with time tag
    C_SE_TB_1 = 62, // set-point scaled command with time tag
    C_SE_TC_1 = 63, // set-point short floating point command with time tag
    C_BO_TA_1 = 64, // bitstring of 32 bit command with time tag
