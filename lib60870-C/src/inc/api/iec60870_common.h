...
typedef enum {      // IEC60870_5_TypeID
    M_SP_NA_1 = 1,  // 0x01 // 单点信息
    M_SP_TA_1 = 2,  // 0x02 // 带时标的单点信息
    M_DP_NA_1 = 3,  // 0x03 // 双点信息
    M_DP_TA_1 = 4,  // 0x04 // 带时标的双点信息
    M_ST_NA_1 = 5,  // 0x05 // 步位置信息
    M_ST_TA_1 = 6,  // 0x06 // 带时标的步位置信息
    M_BO_NA_1 = 7,  // 0x07 // 32比特串
    M_BO_TA_1 = 8,  // 0x08 // 带时标的32比特串
    M_ME_NA_1 = 9,  // 0x09 // 测量值，规一化值
    M_ME_TA_1 = 10, // 0x0a // 带时标的测量值，规一化值
    M_ME_NB_1 = 11, // 0x0b // 测量值，标度化值
    M_ME_TB_1 = 12, // 0x0c // 带时标的测量值，标度化值
    M_ME_NC_1 = 13, // 0x0d // 测量值，短浮点数
    M_ME_TC_1 = 14, // 0x0e // 带时标的测量值，短浮点数
    M_IT_NA_1 = 15, // 0x0f // 累计量
    M_IT_TA_1 = 16, // 0x10 // 带时标的累计量
    M_EP_TA_1 = 17, // 0x11 // 带时标的继电保护或重合闸设备单个事件
    M_EP_TB_1 = 18, // 0x12 // 带时标的继电保护或重合闸设备成组启动事件
    M_EP_TC_1 = 19, // 0x13 // 带时标的继电保护或重合闸设备成组输出电路信息
    M_PS_NA_1 = 20, // 0x14 // 带变位检出的成组单点信息
    M_ME_ND_1 = 21, // 0x15 // 测量值，不带品质描述词的规一化值
    M_SP_TB_1 = 30, // 0x1e // 带时标CP56Time2a的单点信息
    M_DP_TB_1 = 31, // 0x1f // 带时标CP56Time2a的双点信息
    M_ST_TB_1 = 32, // 0x20 // 带时标CP56Time2a的步位置信息
    M_BO_TB_1 = 33, // 0x21 // 带时标CP56Time2a的32位比特串
    M_ME_TD_1 = 34, // 0x22 // 带时标CP56Time2a的测量值, 规一化值
    M_ME_TE_1 = 35, // 0x23 // 带时标CP56Time2a的测量值, 标度化值
    M_ME_TF_1 = 36, // 0x24 // 带时标CP56Time2a的测量值, 短浮点数
    M_IT_TB_1 = 37, // 0x25 // 带时标CP56Time2a的累计量
    M_EP_TD_1 = 38, // 0x26 // 带时标CP56Time2a的继电保护装置事件
    M_EP_TE_1 = 39, // 0x27 // 带时标CP56Time2a的继电保护装置成组启动事件
    M_EP_TF_1 = 40, // 0x28 // 带时标CP56Time2a的继电保护装置成组输出电路信息
    S_IT_TC_1 = 41, // 0x29 // 带时标CP56Time2a的累计量集成总量
    /// 控制命令
    C_SC_NA_1 = 45, // 0x2d // 单命令（不带时标的单点控制命令）
    C_DC_NA_1 = 46, // 0x2e // 双命令（不带时标的双点控制命令）
    C_RC_NA_1 = 47, // 0x2f // 步调节命令
    C_SE_NA_1 = 48, // 0x30 // 设定命令，规一化值
    C_SE_NB_1 = 49, // 0x31 // 设定命令，标度化值
    C_SE_NC_1 = 50, // 0x32 // 设定命令，短浮点数
    C_BO_NA_1 = 51, // 0x33 // 32位比特串命令
    C_SC_TA_1 = 58, // 0x3a // 带时标CP56Time2a的单命令
    C_DC_TA_1 = 59, // 0x3b // 带时标CP56Time2a的双命令
    C_RC_TA_1 = 60, // 0x3c // 带时标CP56Time2a的步调节命令
    C_SE_TA_1 = 61, // 0x3d // 带时标CP56Time2a的设定命令，规一化值
    C_SE_TB_1 = 62, // 0x3e // 带时标CP56Time2a的设定命令，标度化值
    C_SE_TC_1 = 63, // 0x3f // 带时标CP56Time2a的设定命令，短浮点数
    C_BO_TA_1 = 64, // 0x40 // 带时标CP56Time2a的32位比特串命令
    /// 系统命令和信息
    M_EI_NA_1 = 70, // 0x46 // 初始化结束
    S_CH_NA_1 = 81, // 0x51 // 切换命令
    S_RP_NA_1 = 82, // 0x52 // 复位进程命令
    S_AR_NA_1 = 83, // 0x53 // 激活路由命令
    S_KR_NA_1 = 84, // 0x54 // 终止激活路由命令
    S_KS_NA_1 = 85, // 0x55 // 激活设置组命令
    S_KC_NA_1 = 86, // 0x56 // 终止激活设置组命令
    S_ER_NA_1 = 87, // 0x57 // 结束复位进程命令
    S_US_NA_1 = 90, // 0x5a // 唯一标识符
    S_UQ_NA_1 = 91, // 0x5b // 查询唯一标识符
    S_UR_NA_1 = 92, // 0x5c // 唯一标识符就绪
    S_UK_NA_1 = 93, // 0x5d // 唯一标识符未知
    S_UA_NA_1 = 94, // 0x5e // 接受唯一标识符
    S_UC_NA_1 = 95, // 0x5f // 取消唯一标识符

    /// 控制命令
    C_IC_NA_1 = 100, // 0x64 // 总召唤命令
    C_CI_NA_1 = 101, // 0x65 // 电能量召唤命令
    C_RD_NA_1 = 102, // 0x66 // 读命令
    C_CS_NA_1 = 103, // 0x67 // 时钟同步命令
    C_TS_NA_1 = 104, // 0x68 // 测试命令
    C_RP_NA_1 = 105, // 0x69 // 复位进程命令
    C_CD_NA_1 = 106, // 0x6a // 延时获得命令
    C_TS_TA_1 = 107, // 0x6b // 带时标的测试命令
    /// 参数传递
    P_ME_NA_1 = 110, // 0x6e // 测量值参数，规一化值
    P_ME_NB_1 = 111, // 0x6f // 测量值参数，标度化值
    P_ME_NC_1 = 112, // 0x70 // 测量值参数，短浮点数
    P_AC_NA_1 = 113, // 0x71 // 参数激活
    /// 文件传输
    F_FR_NA_1 = 120, // 0x78 // 文件准备就绪
    F_SR_NA_1 = 121, // 0x79 // 节准备就绪
    F_SC_NA_1 = 122, // 0x7a // 召唤目录、选择文件、召唤文件、召唤节
    F_LS_NA_1 = 123, // 0x7b // 最后的节、最后的段
    F_AF_NA_1 = 124, // 0x7c // 认可文件、认可节
    F_SG_NA_1 = 125, // 0x7d // 段
    F_DR_TA_1 = 126, // 0x7e // 目录
    F_SC_NB_1 = 127  // 0x7f // 查询日志，带时标
} IEC60870_5_TypeID;
...
typedef enum {
    ...
    CS101_COT_SPONTANEOUS = 3,                                    //  // 自发的          
    CS101_COT_INITIALIZED = 4,                                    //  // 初始化          
    CS101_COT_REQUEST = 5,                                        //  // 请求或被请求
    CS101_COT_ACTIVATION = 6,                                     //  // 激活
    CS101_COT_ACTIVATION_CON = 7,                                 //  // 激活确认
    CS101_COT_DEACTIVATION = 8,                                   //  // 停用
    CS101_COT_DEACTIVATION_CON = 9,                               //  // 停用确认
    CS101_COT_ACTIVATION_TERMINATION = 10,                        //  // 激活终止
    CS101_COT_RETURN_INFO_REMOTE = 11,                            //  // 远程返回信息
    CS101_COT_RETURN_INFO_LOCAL = 12,                             //  // 本地返回信息
    CS101_COT_FILE_TRANSFER = 13,                                 //  // 文件传输
    CS101_COT_AUTHENTICATION = 14,                                //  // 认证
    CS101_COT_MAINTENANCE_OF_AUTH_SESSION_KEY = 15,               //  // 维护认证会话密钥
    CS101_COT_MAINTENANCE_OF_USER_ROLE_AND_UPDATE_KEY = 16,       //  // 维护用户角色和更新密钥
    CS101_COT_INTERROGATED_BY_STATION = 20,                       //  // 站总召唤
    CS101_COT_INTERROGATED_BY_GROUP_1 = 21,                       //  // 分组1 的召唤
    CS101_COT_INTERROGATED_BY_GROUP_2 = 22,                       //  // 分组2 的召唤
    CS101_COT_INTERROGATED_BY_GROUP_3 = 23,                       //  // 分组3 的召唤
    CS101_COT_INTERROGATED_BY_GROUP_4 = 24,                       //  // 分组4 的召唤
    CS101_COT_INTERROGATED_BY_GROUP_5 = 25,                       //  // 分组5 的召唤
    CS101_COT_INTERROGATED_BY_GROUP_6 = 26,                       //  // 分组6 的召唤
    CS101_COT_INTERROGATED_BY_GROUP_7 = 27,                       //  // 分组7 的召唤
    CS101_COT_INTERROGATED_BY_GROUP_8 = 28,                       //  // 分组8 的召唤
    CS101_COT_INTERROGATED_BY_GROUP_9 = 29,                       //  // 分组9 的召唤
    CS101_COT_INTERROGATED_BY_GROUP_10 = 30,                      //  // 分组10的召唤
    CS101_COT_INTERROGATED_BY_GROUP_11 = 31,                      //  // 分组11的召唤
    CS101_COT_INTERROGATED_BY_GROUP_12 = 32,                      //  // 分组12的召唤
    CS101_COT_INTERROGATED_BY_GROUP_13 = 33,                      //  // 分组13的召唤
    CS101_COT_INTERROGATED_BY_GROUP_14 = 34,                      //  // 分组14的召唤
    CS101_COT_INTERROGATED_BY_GROUP_15 = 35,                      //  // 分组15的召唤
    CS101_COT_INTERROGATED_BY_GROUP_16 = 36,                      //  // 分组16的召唤
    CS101_COT_REQUESTED_BY_GENERAL_COUNTER = 37,                  //  // 通用计数器请求
    CS101_COT_REQUESTED_BY_GROUP_1_COUNTER = 38,                  //  // 分组1计数器请求
    CS101_COT_REQUESTED_BY_GROUP_2_COUNTER = 39,                  //  // 分组2计数器请求
    CS101_COT_REQUESTED_BY_GROUP_3_COUNTER = 40,                  //  // 分组3计数器请求
    CS101_COT_REQUESTED_BY_GROUP_4_COUNTER = 41,                  //  // 分组4计数器请求
    CS101_COT_UNKNOWN_TYPE_ID = 44,                               //  // 未知的类型标识
    CS101_COT_UNKNOWN_COT = 45,                                   //  // 未知的传输原因
    CS101_COT_UNKNOWN_CA = 46,                                    //  // 未知的公共地址
